...
var UnusedImport = &analysis.Analyzer{
	...
	Description: "This checker checks for unused imports in TypeScript code. Unused imports can be removed to reduce the size of the bundle. Unused imports are also a code smell and can indicate that the code is not well-organized.",
