...
func detectSQLInjectionDFG(pass *analysis.Pass) (interface{}, error) {
	...
	analysis.Preorder(pass, func(node *sitter.Node) {
		...
		// TODO:
		// - Add case to handle declaration of Classes.
		// - Add case to handle anonymous function declaration etc.
	})
...
// 					if nameVar != nil {
// 						return IsVulnerableWithDataFlow(nameNode, sourceCode, dataFlowGraph, scope)
